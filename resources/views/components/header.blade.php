  ...
  <nav class="navbar navbar-expand-lg navbar-aura" id="mainNavbar">
    <div class="container-custom d-flex align-items-center justify-content-between">
      ...
      <div class="d-flex align-items-center gap-2 d-lg-none">
        <a href="{{ route('agent.portal') }}" class="btn-aura-user-portal btn-aura-user-portal-sm {{ request()->routeIs('agent.*') ? 'active' : '' }}" title="Agent Portal" aria-label="Agent Portal">
          <i class="fas fa-user"></i>
        </a>
        <button class="navbar-toggler navbar-toggler-aura" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse d-none d-lg-flex justify-content-end align-items-center">
        <ul class="navbar-nav me-3 gap-1">
        ...
        <div class="d-flex align-items-center gap-3">
          <a href="{{ route('agent.portal') }}" class="btn-aura-user-portal {{ request()->routeIs('agent.*') ? 'active' : '' }}" title="Agent Portal" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Agent Portal">
            <i class="fas fa-user"></i>
          </a>
...
<div class="offcanvas offcanvas-end offcanvas-aura" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
  <div class="offcanvas-header border-bottom">
    <div class="d-flex align-items-center gap-2">
      <img src="{{ asset(App\Models\Setting::get('site_logo', 'assets/images/logo.png')) }}" alt="{{ App\Models\Setting::get('site_name', 'Aura Soaps') }}" style="height: 48px; width: auto;">
    </div>
  ...
  <div class="offcanvas-body d-flex flex-column justify-content-between py-4">
    <ul class="navbar-nav gap-3">
      ...
      <li class="nav-item border-top pt-2 mt-1"><a class="nav-link nav-link-aura fs-5 {{ request()->routeIs('agent.portal') ? 'active' : '' }}" href="{{ route('agent.portal') }}" data-bs-dismiss="offcanvas"><i class="fas fa-user me-2 text-warning"></i>Agent Portal</a></li>
    </ul>
