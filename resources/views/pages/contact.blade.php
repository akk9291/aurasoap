...
<main>
  ...
  <section class="page-banner text-center">
    <div class="container-custom">
      ...
      <h1 class="page-banner-title">Contact Aura Soaps & Factory Location</h1>
      <p class="page-banner-subtitle mx-auto">Connect directly with our manufacturing headquarters, central sales desk, or locate your nearest regional Principal Agent.</p>
    </div>
  </section>
