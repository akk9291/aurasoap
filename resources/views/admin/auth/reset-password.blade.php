...
<head>
  ...
  <title>Set New Password | {{ App\Models\Setting::get('site_name', 'Aura Soaps') }} Admin</title>
...
<div class="auth-card text-center">
  ...
  <p class="text-muted fs-7 mb-4">Please choose a strong password to secure your admin account.</p>
  ...
  <form action="{{ route('admin.password.update') }}" method="POST" class="text-start">
    @csrf
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        ...
        <input type="email" name="email" class="form-control border-start-0" value="{{ old('email', $email) }}" required readonly>
      </div>
    </div>
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        ...
        <input type="password" name="password" class="form-control border-start-0" placeholder="Minimum 8 characters" required autofocus>
      </div>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="input-group">
        ...
        <input type="password" name="password_confirmation" class="form-control border-start-0" placeholder="Re-enter password" required>
      </div>
    </div>

    <button type="submit" class="btn btn-aura w-100 mb-3">Reset Password <i class="fas fa-key ms-2"></i></button>
